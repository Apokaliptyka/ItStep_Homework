...
if __name__ == "__main__":
    ...
    director.builder_minimal_computer(specs_min)
    computer_min = builder.get_computer()

    director.builder_full_computer(specs_full)
    computer_full = builder.get_computer()

    print("Full computer", computer_full)
    print("Mini computer", computer_min)
